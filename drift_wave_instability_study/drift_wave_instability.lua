...
n_bar    = 1.0
grad_amp = 0.2   -- keep small so n0 stays positive (here: 0.9..1.1)
...
Nx, Ny   = 64, 64  -- consider making it 64 for a final run
Nvx, Nvy = 16, 16
...
-- Force balance using total pressure gradient
-- local function Ex0_of_x(x)
--   local n0 = n0_of_x(x)
--   return -((T_elc + T_ion)/n0) * dn0dx_of_x(x)
-- end
